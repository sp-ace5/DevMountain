...
sayHelloButton.addEventListener('mouseout', revertColors);
// PROBLEM 4
/*
...
function repeatMyParam() {
    const param = 'This is a test to try out the DOM!';
...
function sendQueryRequest() {
    const query = 'This is a test to request!'; 
  ...
  queryButton.addEventListener('click', sendQueryRequest);
