...
colorRating = faveColorFinder('green')
...
console.log(bestMovie(`Shawshank Redemption`))
...
function theEliminator(people,loser) {
  for (x=0;x<people.length;x++) { 
    if (people[x] == loser) {
      people.splice(people[x],1)
    }
  }
  return people
}
...
console.log(testString(sampleString))
////////////////// PROBLEM 18 ////////////////////
/*
...
console.log(emailCheck('testgmail.com'))
...
totalfrog2 = frogBuyer2(97)
console.log(totalfrog2)
...
function arrTest(arr) {
  return arr.every((value, index, arr) => index === 0 || arr[index - 1] <= value);
}

arrayIsAscending = arrTest(sampleArray)
